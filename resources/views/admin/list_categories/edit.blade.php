                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <form action="{{ route('list_categories.update', $list_category->id) }}" method="POST"
                                    ...
                                    <div class="tab-pane fade show active" id="oz" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ $list_category->translate('oz')->title ?? '' }}"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="ru" role="tabpanel" aria-labelledby="contact-tab">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ $list_category->translate('ru')->title ?? '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="uz" role="tabpanel" aria-labelledby="profile-tab">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ $list_category->translate('en')->title ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="thumbnail" class="form-control col-sm-11 d-inline" type="text"
                                                   name="filepath" value="{{ $list_category->image }}">
                                            <a id="lfm" data-input="thumbnail" data-preview="holder">
                                                {{ __('main.choose') }}
                                            </a>
                                            <img src='{{ $list_category->image  }}' alt="" style="width: 100px; margin-top: 5px;">
                                        </div>
                                    </div>
