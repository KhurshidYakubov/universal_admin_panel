                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <form action="{{ route('list_types.update', $list_type->id) }}" method="POST"
                                    ...
                                    <div class="tab-pane fade show active" id="oz" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ $list_type->translate('oz')->title ?? '' }}"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="uz" role="tabpanel" aria-labelledby="profile-tab">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ $list_type->translate('uz')->title ?? '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="ru" role="tabpanel" aria-labelledby="contact-tab">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ $list_type->translate('ru')->title ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
