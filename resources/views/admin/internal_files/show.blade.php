            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">{{ __('main.internal_files') }} #{{ $list->id }}</h1>
                        <form action="{{ route('internal_files.destroy', $list->id) }}" method="POST">
                            <a href="{{route('internal_files.create')}}"
                               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                    class="fas fa-plus-circle"></i></a>
                            <a href="{{ route('internal_files.index') }}"
